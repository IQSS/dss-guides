...
| `git log` | This will print out a log of the commits for your repository. Press `q` to leave the log and return to the prompt. |
...
| `git commit . -v` | The "." means that everything will be included in your commit. The "-v" stands for "verbose" and means that git will show the diff of the changes being committed in the editor while you write the message. |
