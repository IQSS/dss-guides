...
<ol type="1">
  <li>Pull: in the terminal window, type <code>git pull</code></li>
  <ol type="a">
    <li>This merges in any changes someone else made to the repo</li>
  </ol>
  <li>Commit: in the terminal window, type <code>git commit -am "your commit message"</code> </li>
  <ol type="a">
    <li>This prepares your changes for uploading</li>
  </ol>
  <li>Push: in the terminal window, type <code>git push</code></li>
  <ol type="a">
...
<ol type="1">
  <li>Commit: in the terminal window, type <code>git commit -am "your commit message"</code>
</li>
  <ol type="a">
