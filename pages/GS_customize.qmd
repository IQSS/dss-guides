...
2. Google Sites allows the option to include resume sections as plain text on the site, or as a Google Doc/PDF, or both. Choose whichever you'd like.
...
<summary>If you have your resume as a PDF:</summary>
  <ol type="a">
    ...
    <li>Click the blue "Insert" button.</li>
    <li>Note that this will insert the PDF in a new section under your current section.</li>
  </ol>
</details>
...
Once you are done editing your site, you are ready to publish it.
...
<details>
<summary>If you get an error about access to a file, you need to make sure the file is publicly viewable:</summary>
  <ol type="a">
