...
13. Inside the file, copy and paste this text:
  ...
  ```
14. Click the green "Commit changes..." button at the top right. In the pop-up, you don't need to change the defaults. However, in the future, it may be useful to leave descriptive commit messages that tells your future self what you changed in that version in case you need to go backward!
...
17. Now check your website by going to `[username].github.io`. It should say, in very basic styling, a large heading reading "Hello World" and a line of text reading "I'm hosted with GitHub Pages."
