...
5. Inside the file, copy and paste this text:
...
9. Check your actual website by going to username.github.io. It should say, in very basic styling, a large heading reading "Hello World" and a line of text reading "I'm hosted with GitHub Pages."
...
If you need more instructions about committing and pushing to GitHub, or if you want to use the Terminal/Command Line, check out our [Git and GitHub Guide](../git/index.qmd).
