...
Unzip the download (it will be named something like `VSCode-darwin-universal.zip`), and then click on the new application (Visual Studio Code). A pop-up will ask you if you want to open an app downloaded from the internet. Click open.
